...
- **Fase 2 (imágenes)**: workflow-1/2/3 (resize 1200px) + workflow-4 + team → WebP; preview.png→preview.jpg 208KB. media/ ~26→16MB. PENDIENTE (requiere ffmpeg, NO instalado): recomprimir escaneo-lidar.mp4 (5.7MB), posters de video, hospedar hero video local (hoy hotlink imgur).
